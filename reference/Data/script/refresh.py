...
def refresh_s(id):
    ...
    cursor.execute('select MAX(`date`) from `s_2016` where `stockid`= "' + id + '"')
...
##################################################################################
    ...
    for x in range(0, len(data1)):
        ...
        if str(data1[x][1]) == str(data2[start_point+i][0]):
            data1[x].extend(data2[start_point+i][1:])
            i += 1
        else:
            data1[x].extend([None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None])
    print data1

    # insert_cmd = 'INSERT INTO `s_2016` ' \
    #                                             '(`stockid`, `date`, open, high, low, close, volume, ' \
    #                                             'adj_price, turnover, pe_ttm, pb,  ' \
    #                                             '`dif`, `dea`, `macd`, `slowK`, `slowD`, `slowJ`, `boll_upper`, `boll_middle`, ' \
    #                                             '`boll_low`, `ma5`, `ma10`, `ma20`, `ma30`, `ma60`, `atr`, `rsi` ,' \
