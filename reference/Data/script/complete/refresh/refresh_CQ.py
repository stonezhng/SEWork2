...
def refresh_committee(id):
    ...
    while valid != 5:
        ...
        com2 = 0
        try:
            df = ts.get_tick_data(id[2:], date=end.strftime("%Y-%m-%d"), retry_count=1)
            # print df
            ...
            break
        # print id + ' ' + end.strftime("%Y-%m-%d")
        # value = get_hist_committee(id, end.strftime("%Y-%m-%d"))
        # print value
...
while 1:
    ...
    try:
        ...
        print
# refresh_committee('sz002569')
# refresh_quantity('sz002569')
